...
- Latency average / p95: 20.558s / 20.558s

| Case | Verdict | Request | Elapsed | Planner | Source | Tools | Replan | Stop | Failure |
| --- | --- | --- | ---: | --- | --- | --- | ---: | --- | --- |
| E11 | PASS | `req-f8da8a44` | 20.558 | valid | llm_planner | get_entity_month_table | 0 | completed |  |

## E11 PASS

- Request ID: `req-f8da8a44`
